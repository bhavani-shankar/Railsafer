...
<form class="form-signin">
    ...
    <h2 class="form-signin-heading text-center">PNR Enquiry</h2>
    <label class="col-form-label"><h6>Enter PNR Number:</h6></label> 
    <input type="text" class="form-control" name="" placeholder="PNR Number" required="" autofocus="">
    
    <button class="btn btn-lg btn-primary btn-block">Check PNR Status</button>
