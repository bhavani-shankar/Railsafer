...
<div class="wrapper">
<form class="form-signin" action="running_trains.php" method="POST">
    
    <h2 class="form-signin-heading text-center">Running Status</h2>
    <label class="col-form-label"><h6>Enter Train Number:</h6></label> 
    <input type="text" class="form-control" name="train" placeholder="Train Number" required="" autofocus="">
        <label class="col-form-label"><h6>Enter Journey Station:</h6></label> 
    <input type="text" class="form-control" name="station" placeholder="Station Name" required="" autofocus="">
    <label ><h6>Enter Journey Date:</h6></label>
    <input type="date" class="form-control" name="date" placeholder="" value="<?php echo date('Y-m-d'); ?>" required="" autofocus="">
