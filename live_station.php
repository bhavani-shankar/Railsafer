...
<head>
	...
	<style>
      ...
      .form-signin input[type="radio"],input[type="text"]{
          margin-bottom: 25px;
      }
...
<div class="wrapper">
<form class="form-signin" action="live_trains.php" method="POST">
    
    <h2 class="form-signin-heading text-center">Live Station</h2>
    <label class="col-form-label"><h6>Enter Station:</h6></label> 
    <input type="text" class="form-control" name="station" placeholder="Enter Station" required="" autofocus="">
    <label class="col-form-label"><h6>Enter Hours:</h6></label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="radio" name="hour" value="2">&nbsp;2 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="radio" name="hour" value="4">&nbsp;4

    <button class="btn btn-lg btn-primary btn-block" id="d1">Check Trains</button>
