...
<form class="form-signin" action="connection.php" method="post">
    ...
    <input type="text" class="form-control" id="i1" name="UserName" placeholder=" UserName" required="" autofocus="">
    <input type="password" class="form-control" id="i2" name="Password" placeholder=" Password" required="" autofocus="">
    <label class="ab"><a href="forgot_form.php" style="text-decoration: none;">forgot password?</a></label>
    
    <button class="btn btn-lg btn-primary btn-block">Login</button><hr>
    <a href="register.php" class="btn btn-primary btn-lg btn-block" role="button">Register</a>
