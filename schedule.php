...
<div class="wrapper">
<form class="form-signin" action="train_schedule.php" method="POST">
    
    <h2 class="form-signin-heading text-center">Train Schedule</h2>
    <label class="col-form-label"><h6>Enter Train Number:</h6></label> 
    <input type="text" class="form-control" name="number" placeholder="Train Number" required="" autofocus="">

    <button type="submit" class="btn btn-lg btn-primary btn-block" id="d1">Check Schedule</button>
