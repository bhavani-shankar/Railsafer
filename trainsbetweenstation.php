<html>
    ...
    <body>
        ...
        $To = $_POST['ToName'];
         ...
         $sql = "SELECT * FROM train_details WHERE (SourceStationName = '$From' OR SourceStationCode = '$From') AND (DestinationStationName = '$To' OR DestinationStationCode = '$To')";
         $result = mysqli_query($con,$sql);
         ?>
            <div class="container" style="margin-top: 20px;">
            <div class="row text-center">
            <div class="col-lg-12"><h2><?php echo $From." TO ".$To." TRAINS"; ?></h2></div>
            </div>
         <?php
