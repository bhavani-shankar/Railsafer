...
<div class="wrapper">
<form class="form-signin" action="connection_contact.php" method="post">
    
    <h2 class="form-signin-heading text-center">Contact Us</h2>
    <label class="col-form-label"><h6>Name:</h6></label> 
    <input type="text" class="form-control" name="Name" placeholder="Name" required="" autofocus="">
    <label class="col-form-label"><h6>Email:</h6></label> 
    <input type="text" class="form-control" name="Email" placeholder="Email" required="" autofocus="">
    <label class="col-form-label"><h6>Message:</h6></label> 
